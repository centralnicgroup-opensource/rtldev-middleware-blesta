...
// Generic API failure, used when the registry returns no usable message
$lang['Cnr.!error.unexpected'] = "The request could not be completed. Please try again or contact support.";

// Module row settings added alongside the credentials
$lang['Cnr.row_meta.proxy_server'] = "Proxy Server (optional)";
$lang['Cnr.row_meta.dns_nameservers'] = "DNS Management Nameservers (optional)";
$lang['Cnr.row_meta.default_ttl'] = "Default DNS Record TTL (optional)";
$lang['Cnr.!error.proxy_server.valid'] = "The proxy server must be a URL, for example http://proxy.example.com:8080.";
$lang['Cnr.!error.dns_nameservers.valid'] = "Enter a comma separated list of host names, for example ns1.dnsres.net, ns2.dnsres.net.";
$lang['Cnr.!error.default_ttl.valid'] = "The default TTL must be a whole number of seconds greater than zero.";
$lang['Cnr.!error.renew.no_expiration'] = "The renewal could not be completed because the current expiration date could not be read from the registry.";

// Order fields checked before the order is invoiced
$lang['Cnr.!error.domain.empty'] = "Please enter a domain name.";
$lang['Cnr.!error.domain.format'] = "The domain name is not valid, for example example.com.";
$lang['Cnr.!error.ns.format'] = "Each nameserver must be a host name, for example ns1.dnsres.net.";
